...
function _ssr() {
  _ssr = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(url, browserWSEndpoint) {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 15:
            ...
            return page.evaluate(function () {
              var elements = document.querySelectorAll('script:not(.notremove), link[rel="import"], style, #__SVG_SPRITE_NODE__');
